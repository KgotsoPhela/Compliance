...
if reactive:
    ...
    with st.expander('**Open Non-compliance Board**'):
        im = Image.open('C:/Users/KgotsoPhela(LubanziI/Music/Black Technology LinkedIn Banner(2).png')
        st.image(im)
    ...
    imgg = Image.open('C:/Users/KgotsoPhela(LubanziI/Desktop/s.png')
    st.image(imgg)
    # Create a dataframe
    ...
    df = pd.DataFrame({
        'Name': ['John', 'Sarah', 'Mike', 'Jane', 'David'],
        'Age': [28, 31, 45, 22, 39],
        'Salary': [50000, 75000, 60000, 40000, 80000],
